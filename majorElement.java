// Questão:
// Dado um array de tamanho n, ache o Elemento Majoritário.
// O Elemento Majoritário é o elemento que aparece mais que a metade inteira de n/2 [floor(n/2)].
// Você pode assumir que o array não é vazio e que o elemento majoritário existe.
import java.util.*;
...
public class majorElement {
    ...
    public static void main(String[] args) {
        ...
        int x, a = 0; //variável do número de elementos do array (x) e do laço while (a)
        int[] arrayint;
